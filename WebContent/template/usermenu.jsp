...
<img src="<%=request.getContextPath()%>/icons/dashboard.png" alt="DashBoard" class="img-rounded menu" onclick="forwardTo('<%=request.getContextPath()%>/jsp/userdashboard.jsp')" style="float: left;">
